      ...
      >
        ...
        <div className="page-fade-in relative z-10 mx-auto flex w-full max-w-[1520px] flex-col px-4 py-4 sm:px-8 sm:py-8 lg:px-14">
          ...
          <section className="relative pt-16 sm:pt-20 lg:pt-24">
            <div className="grid gap-10 lg:grid-cols-[1.08fr_auto] lg:items-start">
              <div className="space-y-7" data-reveal="left">
                ...
                <h1
                  className="intro-rise max-w-[920px] text-[2.45rem] font-extrabold leading-[0.9] tracking-[-0.08em] text-[#181818] sm:text-[4.2rem] lg:text-[5.2rem]"
                  style={{ ["--intro-delay" as string]: "80ms" }}
                >
                  {project.heroTitle}
                </h1>
                <p
                  className="intro-rise max-w-[760px] text-lg leading-relaxed text-[#4d4d4d] sm:text-xl"
              ...
              <div className="pt-2" data-reveal="right">
                <div className="border border-[#1c1c1c] bg-white px-5 py-4 text-sm font-semibold text-[#111] shadow-[4px_4px_0_#1c1c1c] sm:text-base">
                  {project.category}
                </div>
              </div>
            </div>
          ...
          <section className="relative py-16 sm:py-20">
            ...
            <p className="mt-6 max-w-[1280px] text-base leading-relaxed text-[#4e4e4e] sm:text-lg">
              {project.description}
            </p>
          </section>
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {project.gallery.map((image, index) => (
                  <div
                    key={image}
                    data-reveal="up"
                    className="border border-[#1c1c1c] bg-white p-3 shadow-[4px_4px_0_#1c1c1c]"
          ...
          <section className="relative pb-20 pt-10 sm:pb-24">
            <div className="border border-[#1c1c1c] bg-[#faf9f5] px-6 py-7 shadow-[4px_4px_0_#1c1c1c] sm:px-8 sm:py-8">
              ...
              <div className="relative z-10 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                <h2 className="text-[2.2rem] font-extrabold leading-[0.94] tracking-[-0.07em] text-[#1f1f1f] sm:text-[3rem]">
                  Ver mais projetos da Gate80
                </h2>
